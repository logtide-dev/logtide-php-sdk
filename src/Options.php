...
final class Options
{
    ...
    /** @var IntegrationInterface[]|callable|null */
    private array|callable|null $integrations = null;
    ...
    /** @return IntegrationInterface[]|callable|null */
    public function getIntegrations(): array|callable|null
    {
